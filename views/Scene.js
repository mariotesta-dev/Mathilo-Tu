...
export default function Scene({route, navigation}) {
  ...
  const [showTopInPreview, setShowTopInPreview] = useState(false);
        ...
        {!editMode && (
          <>
            <TouchableOpacity
              ...
              onPress={() => {
                setShowTopInPreview(!showTopInPreview);
              }}>
            ...
            <View
              style={[
                showTopInPreview ? styles.show : styles.hide,
                {zIndex: 1},
              ]}
              pointerEvents="none">
